(module
  (import "cm32p2|conduit:plugin/http-client-v1" "get"
    (func $http-get (param i32 i32 i32)))
  ...
  (data (i32.const 112) "httpOperation")
  ...
  (func (export "cm32p2|conduit:plugin/openapi-provider-v1|get-operation")
    ...
    ;; http-client result area starts at 512.
    local.get $path-ptr
    local.get $path-len
    i32.const 512
    call $http-get
    ...
    ;; operation-id: some("httpOperation")
    i32.const 304
    i32.const 1
    i32.store
    i32.const 308
    ...
    ;; summary: some(http response body)
    i32.const 316
    i32.const 1
    i32.store
    i32.const 320
