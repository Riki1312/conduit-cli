(module
  ...
  (data (i32.const 104) "/fixture")
  (data (i32.const 112) "fixtureOperation")
  (data (i32.const 128) "Fixture operation")
  ...
  (func (export "cm32p2|conduit:plugin/openapi-provider-v1|get-operation")
    ...
    ;; operation-id: some("fixtureOperation")
    i32.const 304
    i32.const 1
    i32.store
    i32.const 308
    ...
    ;; summary: some("Fixture operation")
    i32.const 316
    i32.const 1
    i32.store
    i32.const 320
